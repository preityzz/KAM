        ...
        >
          <blockquote className="space-y-4">
            <p className="text-xl text-white/90">
              &ldquo;Transform your restaurant management experience with our
              comprehensive lead tracking and performance analytics
              solution.&rdquo;
            </p>
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-xl backdrop-blur-lg">
            <div className="flex flex-col space-y-4 text-center">
              ...
              <p className="text-[#B8C4C9]">Sign in to access your account</p>
            </div>
            <UserAuthForm />
